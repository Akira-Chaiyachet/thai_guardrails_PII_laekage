...
def test_system():
    ...
    input_text = "สวัสดีครับ ผมชื่อสมชาย มีเงิน 1479300026261 บาท เลขบัตร 1479300026261 เบอร์โทร 0812345678 ส่วนอันนี้เลขมั่ว 1234567890123 เบอร์โทร +66812345678"
